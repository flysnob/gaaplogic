...
<!--[if (gte IE 9)|(gt IEMobile 7)|!(IEMobile)|!(IE)]><!--><html <?php language_attributes(); ?> class="no-js"><!--<![endif]-->
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri(); ?>/library/css/cmxform.css">
		
		<!--<script src="<?php echo get_template_directory_uri(); ?>/library/js/nodes.js"></script>-->
	...
	<body <?php body_class(); ?>>
		...
		<header role="banner">
			...
			<script type="text/javascript">stLight.options({publisher: "b19d5e1a-9729-4be6-ac99-737af25c4ee4", doNotHash: false, doNotCopy: false, hashAddressBar: false});</script>
